...
## Что ещё нужно сделать по заданию (если требуется)
- Залить проект в GitHub и приложить ссылку на репозиторий
- (Опционально) Развернуть в интернете на публичном сервере и вставить ссылку в отчёт
- Добавить скриншоты работы (Swagger UI и ответы API) в этот README
- Если преподаватель требует, можно добавить CI/CD (GitHub Actions) для сборки Docker/публикации docs
